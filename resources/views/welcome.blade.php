...
<head>
  ...
  <style>
    ...
    * {
    ...
    .device:hover {
      transform: perspective(1200px) rotateY(-3deg) rotateX(0deg) translateY(-3px)
    }
    ...
    .sec-title {
      ...
      margin: 0 0 10px;
      font-weight: 900;
      background: linear-gradient(90deg, #fff, #9ec9ff 50%, #9affdd);
    ...
    .avatar {
      ...
      height: 72px;
      border-radius: 50%;
      background: linear-gradient(135deg, #d4fff2, #a3bfff);
...
<body>
  ...
  <nav class="nav">
    <div class="nav__wrap">
      <a href="#" class="brand" aria-label="Ir al sitio de TUXON (placeholder)">
        <img src="{{ asset('img/logo/tuxson1.jpg') }}" alt="">
  ...
  <header class="hero">
    <div>
      <span class="eyebrow">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="#7aa2f7" aria-hidden="true">
          <path d="M12 1l3 5 5 3-5 3-3 5-3-5-5-3 5-3 3-5z" />
        </svg>
      ...
      <div class="seals">
        <div class="seal">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#5eead4" aria-hidden="true">
            <path d="M12 1l9 4v6c0 5-4 9-9 12-5-3-9-7-9-12V5l9-4zm-3 11l2 2 4-5-1.5-1-2.5 3-1-1-1.5 2z" />
          </svg>
          Cifrado extremo a extremo
        </div>
        <div class="seal">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#ffd166" aria-hidden="true">
            <path d="M12 2a5 5 0 015 5v3h2a1 1 0 011 1v9a2 2 0 01-2 2H6a2 2 0 01-2-2v-9a1 1 0 011-1h2V7a5 5 0 015-5zm-3 8h6V7a3 3 0 10-6 0v3z" />
          </svg>
          Autenticación con QR
        </div>
        <div class="seal">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#9affdd" aria-hidden="true">
            <path d="M3 6h18v12H3V6zm2 2v8h14V8H5zm3 1h3v3H8V9zm5 0h3v3h-3V9z" />
          </svg>
    ...
    <div class="device" aria-label="Demostración de pago con QR">
      ...
      <div class="screen">
        ...
        <button class="paybtn" id="mockPay">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#0a0d14" aria-hidden="true">
            <path d="M3 7h18v10H3V7zm2 2v6h14V9H5zm2 1h3v2H7v-2zm9 0h3v2h-3v-2z" />
          </svg>
          Escanear y Pagar
        </button>
      </div>
